...
class MenuItemSerializer(generics.RetrieveAPIView):
        throttle_classes = [AnonRateThrottle, UserRateThrottle]
        queryset = MenuItem.objects.all()
        serializer_class = MenuItemSerializer
        ...
        def patch(self, request, *args, **kwargs):
                ...
                status=200,
                data={
                        "message": "Featured status of {} changed t0 {}".format(
                        str(menuitem.title, menuitem.featured)
                        )
                },
                )
...
class ManagersRemoveView(generics.DestroyAPIView):
        ...
        def delete(self, request, *args, **kwargs):
                ...
                return JsonResponse(
                status=200, data={"message": " User removed from the Managers group"}
                )
...
class DeliveryCrewRemoveView(generics.DestroyAPIView):
        ...
        def delete(self, request, *args, **kwargs):
                ...
                return JsonResponse(
                        status = 201,
                        data = {
                                'message':'User has been removed from the delivery crew'
                        }
                )
